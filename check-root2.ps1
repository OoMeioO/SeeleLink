...
try {
    ...
    # Use simple expression without nested quotes
    $msg = @{"id"=1;"method"="Runtime.evaluate";"params"=@{"expression"="document.getElementById(`"root`").innerHTML";"returnByValue"=$true}} | ConvertTo-Json -Compress
    ...
    Write-Host "Root innerHTML: $result"
